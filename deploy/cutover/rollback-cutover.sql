...
-- reservation.duration wieder anlegen. random_string() (siehe Common/resources/
-- database-init.sql) wurde von V10 NICHT entfernt und wird hier vorausgesetzt.
-- ============================================================================================

-- Reihenfolge wie im Original (Common/resources/database-init.sql): erst die Spalte
...
-- anlegen (DDL/Grants aus Common/resources/database-init.sql übernommen). Rollen können nicht
...
-- Common/resources/database-init.sql übernommen. Setzt voraus, dass "reservations" bereits
