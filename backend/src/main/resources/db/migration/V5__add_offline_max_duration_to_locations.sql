-- Phase 4 AP6 (siehe docs/kb/05-migration-plan.md "Konzeptskizze: Offline-Buchungen am Terminal"
...
-- mit.
--
-- Auftraggeber-Vorgabe (siehe docs/kb/05-migration-plan.md, "Entscheidungen (Auftraggeber)"
