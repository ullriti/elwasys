...
kb/05-migration-plan.md, Zielarchitektur). Ursprünglich (Phase 2 AP1) im Strangler-Muster
...
kb/06-ui-tests.md). Phase 4 stellte die Terminals auf diese REST-API/WebSocket-Schicht als
...
mit dem gesamten Alt-Portal-Modul, siehe kb/05-migration-plan.md, „Entscheidungen").
...
entfernt, siehe kb/05-migration-plan.md, „Entscheidungen“.
