...
| 2026-07-20 | **Phase 1 (Client-Raspi Java 21 + ElwaManager-DI)**: Client-Raspi auf Java 21 gehoben, minimaler DI-Seam für `ElwaManager` eingeführt, 12 neue isolierte Charakterisierungstests für `MainFormStateManager` (JUnit 5, ohne TestFX/DB); volle Client-Suite grün (33/33) |
