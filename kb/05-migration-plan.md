...
> TLS-Konzept) sind abgeschlossen - die Phase-2-Roadmap ist damit vollständig abgearbeitet,
> siehe Roadmap unten. Phase 2 selbst wird noch NICHT als abgeschlossen markiert
> (entscheidet der Koordinator nach der QA-Review von AP6).
...
- [x] Deployment: Dockerfile + docker-compose (Backend + Postgres) **und** Helm Chart
      ...
      2026-07-20 - Phase-2-Roadmap damit vollständig abgearbeitet; Phase 2 selbst wird
      NICHT als abgeschlossen markiert, das entscheidet der Koordinator nach der
      QA-Review dieses Arbeitspakets)*
