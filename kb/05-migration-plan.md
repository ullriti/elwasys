...
> Änderungslog „Phase 3 AP2" und in der Risikotabelle unten). Nächster Schritt: Phase 3 AP3
> (Dashboard/UsersDashboard, Guthaben/CreditAccounting inkl. Aufladen, Passwort ändern).
...
- [ ] Views mit Feature-Parität laut Inventar: Dashboard, Users, UserGroups, Devices,
      ...
      Guthaben ist in der Benutzerliste nur ANZEIGE [`CreditService#getCredit`], Aufladen +
      Dashboard/UsersDashboard folgen in AP3 – daher hier bewusst NICHT abgehakt)
