...
`Client-Raspi/pom.xml package` grün. Details im Änderungslog „Phase 4 AP2". Nächster
Schritt: **Phase 4 AP3** (Backend-Vorbereitung: API-Erweiterungen, Idempotenz,
Snapshot-Endpunkt, Benachrichtigungen backend-seitig anbinden).
