...
> Roadmap-Punkt „Dialoge/Funktionen“ vollständig abgedeckt. Nächster Schritt: Phase 3 AP5
> (Live-Updates zwischen Sessions).
...
- **Blockierender Request/Response-Aufruf in der Fernwartungs-UI** (seit Phase 3 AP4,
  ...
  einem verbundenen, aber nicht antwortenden Terminal) - akzeptabel ohne die in AP5 geplanten
  Live-Updates/Push, sollte aber überprüft werden, sobald AP5 eine Push-Infrastruktur einführt
  (dann ließe sich die Anfrage asynchron mit einem Ladeindikator lösen, statt den
